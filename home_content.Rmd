...
* [Quality control (Lab)](lab_qc.html)
...
* [Quality control (Lab)](lab_qc.html) (Same document as before)

BAM files are visualised using integrated genome viewer.
...
## Mapping and quantification using Pseudoaligners
...
* [Reference-guided assembly using StringTie and De-novo assembly using Trinity (Lab)](lab_assembly.html)  
