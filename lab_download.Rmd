...
ds[grepl("mouse",tolower(ds$description)),]
```
...
```
     ensembl_gene_id entrezgene_id hgnc_symbol chromosome_name start_position end_position
1 ENSMUSG00000118554        631145     CXorf58               X       94339903     94364570
2 ENSMUSG00000118505        546801       ETV3L               3       87550099     87561109
3 ENSMUSG00000064336            NA                          MT              1           68
4 ENSMUSG00000064337            NA                          MT             70         1024
5 ENSMUSG00000064338            NA                          MT           1025         1093
6 ENSMUSG00000064339            NA                          MT           1094         2675
  strand   gene_biotype
1     -1 protein_coding
2      1 protein_coding
3      1        Mt_tRNA
...
6      1        Mt_rRNA
                                                                    description
1  family with sequence similarity 90, member A1B [Source:NCBI gene;Acc:631145]
2                              ets variant 3-like [Source:NCBI gene;Acc:546801]
3 mitochondrially encoded tRNA phenylalanine [Source:MGI Symbol;Acc:MGI:102487]
4           mitochondrially encoded 12S rRNA [Source:MGI Symbol;Acc:MGI:102493]
5        mitochondrially encoded tRNA valine [Source:MGI Symbol;Acc:MGI:102472]
6           mitochondrially encoded 16S rRNA [Source:MGI Symbol;Acc:MGI:102492]
```
...
sum(duplicated(bdata$hgnc_symbol))
```
...
```{r,eval=FALSE}
mart <- biomaRt::useMart(biomart="ensembl",dataset="mmusculus_gene_ensembl")
bdata <- getBM(mart=mart,attributes=c("entrezgene_id","go_id","go_linkage_type"),uniqueRows=T)
...
getLDS(attributes=c("ensembl_gene_id"),filters="ensembl_gene_id",values=mouse_genes,mart=mouse, attributesL=c("hgnc_symbol"),martL=human,valuesL="hgnc_symbol",uniqueRows=F)
```
