...
cl <- pheatmap( logcpm[selected_genes,] , scale = "row" , color = colorRampPalette(c("navy","white","firebrick"))(90), border_color = NA, cluster_cols = F,cutree_rows = 2)
...
barplot( -log10(go_cluster$P.value[15:1]), horiz = T, names.arg = go_cluster$Term[15:1],las=1)
```
...
mypar(1,1,mar=c(2,20,2,2))
barplot( -log10(kegg_cluster$P.value[15:1]), horiz = T, names.arg = kegg_cluster$Term[15:1],las=1)
```
