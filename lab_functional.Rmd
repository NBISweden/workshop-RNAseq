...
# read data
download_data("data/gene_counts_vst.csv")
data <- read.csv("data/gene_counts_vst.csv",row.names = 1)
dim(data)
...
```{r heatmap,results='hide',block.title=TRUE,fig.height=7,fig.width=5}
