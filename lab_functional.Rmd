...
The cpm data and metadata can be downloaded from [this location](https://github.com/NBISweden/course_rnaseq/tree/master/data). The files needed are **cpm.csv** and **metadata_raw.csv**. Place the files in a directory named `data` in your current working directory.
</div>
...
<div class="boxy boxy-exclamation">
For this exercise, the database files are available at [this location](https://github.com/NBISweden/course_rnaseq/tree/master/data). You need the whole directory labelled **MSigDB_files**. Place this directory under a directory named `data` in your current working directory. Otherwise, set the path appropriately.
</div>
