...
Download the cDNA reference and create a index file to run on (This has already been done!)
...
# Convert from transcript estimation to gene estimations.


This is done based on the [txImport vignette](https://bioconductor.org/packages/release/bioc/vignettes/tximport/inst/doc/tximport.html)

For the program to work it needs a trancript to gene converter. This is written in the cDNA names in the fasta file. 
...
# Convert to a DEseq2 object for analysis
