...
Make sure that you have the [**Slack**](https://slack.com/intl/en-se/downloads) installed because we will use it a lot during the course. Communication, troubleshooting and group discussions will happen via **Slack workspace NBIS-workshop-RNAseq**. All accepted students will receive an invitation link via email. Please add this workspace to your Slack application on the desktop and do **NOT** use it in the web.
...
```{sh,eval=FALSE,block.title=TRUE}
#Ubuntu
wget https://nbisweden.github.io/workshop-RNAseq/environment_RNAseq2020.yml
