...
#MacOSX
curl -o environment_RNAseq2020.yml https://raw.githubusercontent.com/NBISweden/workshop-RNAseq/master/environment_RNAseq2020.yml
```
...
The data being used in this workshop is available [here](https://drive.google.com/drive/u/0/folders/1mDMZFdx5oXm0HSVq6hm9j2AC_ebg4cM3). However, we recommend you to download it using terminal, which simplify things a lot.
...
for i in lab_annotation.Rmd lab_dge.Rmd lab_download.Rmd lab_eda.Rmd lab_functional.Rmd lab_preprocessing.Rmd
do
