...
For Linux and Mac users, you may have to install some extra OS specific softwares before installing the R packages. Pick the packages as needed based on your system below.
