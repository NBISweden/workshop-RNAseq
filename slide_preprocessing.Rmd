...
author: "`r paste0('<b>Roy Francis and Nima Rafati</b> | ',format(Sys.time(), '%d-%b-%Y'))`"
...
**Upper Quartile (UQ)**
In Upper Quartile normalization, the expressino values are divded by 75th quantile of the counts for each samples
