...
source("https://raw.githubusercontent.com/NBISweden/workshop-RNASeq/assets/scripts.R")
```
...
download_data("data/human_biomaRt_annotation.csv")
...
download_data("data/mock_pvc.Rds")
mock_pvc <- readRDS("data/mock_pvc.Rds")

download_data("data/pvc.Rds")
