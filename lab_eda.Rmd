...
data <- read.csv("data/counts_raw.csv",header=TRUE,stringsAsFactors=FALSE,row.names=1)
...
annot <- read.csv("data/mouse_genes.txt",row.names=1,stringsAsFactors=FALSE)
