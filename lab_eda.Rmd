...
if(!file.exists("data/count_raw.txt")) {
  download.file(url="https://raw.github.com/NBISweden/workshop-RNAseq/master/data/count_raw.txt","./data/count_raw.txt")
}
...
# optionally, get annotation from biomart
...
if(!file.exists("data/human_biomaRt_annotation.csv")) {
  download.file(url="https://raw.github.com/NBISweden/workshop-RNAseq/master/data/human_biomaRt_annotation.csv","./data/human_biomaRt_annotation.csv")
}
...
# if file doesn't exist, download it
if(!file.exists("data/mock_pvc.Rds")) {
  download.file(url="https://raw.github.com/NBISweden/workshop-RNAseq/master/data/mock_pvc.Rds","./data/mock_pvc.Rds")
}

mock_pvc <- readRDS("data/pvc.Rds")

# if file doesn't exist, download it
if(!file.exists("data/mock_pvc.Rds")) {
  download.file(url="https://raw.github.com/NBISweden/workshop-RNAseq/master/data/pvc.Rds","./data/pvc.Rds")
}
